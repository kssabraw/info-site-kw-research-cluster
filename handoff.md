...
code). §5 is otherwise still pre-refactor in places — new modules
(`pipeline/metrics.py`, `pipeline/llm_router.py`, `pipeline/silo_anchor.py`,
`app/cancellation.py`) exist on `main` but aren't mapped there yet._
